...
namespace WpfClientApp.wpfDBDataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Student] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_" +
                "Name) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)))";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Student] SET [Name] = @Name, [Age] = @Age WHERE (([Id] = @Original_" +
                "Id) AND ([Name] = @Original_Name) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([" +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WpfClientApp.Properties.Settings.Default.wpfDBConnectionString;
        }
        ...
        public virtual int Fill(wpfDBDataSet.StudentDataTable dataTable) {
        ...
        public virtual wpfDBDataSet.StudentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            wpfDBDataSet.StudentDataTable dataTable = new wpfDBDataSet.StudentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(wpfDBDataSet.StudentDataTable dataTable) {
